...
sweep=dc
rawfile=$netlist_dir/ac_mosvar.raw}
B 2 1127.5 320 1927.5 720 {flags=graph
...
C {sg13g2_pr/sg13_svaricap.sym} 0 160 2 0 {name=C1 model=sg13_hv_svaricap w=9.7e-6 l=0.8e-6 Nx=30 spiceprefix=X}
C {sg13g2_pr/rppd.sym} -230 310 0 0 {name=R1
w=0.5e-6
l=5e-6
model=rppd
body=sub!
