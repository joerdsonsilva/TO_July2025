...
N 880 -530 880 -510 {
lab=VCO}
N 2640 -980 2640 -950 {lab=#net1}
N 2640 -810 2640 -780 {lab=#net2}
N 2320 -920 2570 -920 {lab=#net3}
N 2280 -900 2570 -900 {lab=#net4}
N 2480 -840 2570 -840 {lab=v_gain}
N 2320 -930 2320 -920 {lab=#net3}
N 2230 -920 2320 -920 {lab=#net3}
N 2280 -1000 2280 -900 {lab=#net4}
N 2230 -900 2280 -900 {lab=#net4}
N 2280 -1000 2320 -1000 {lab=#net4}
N 2320 -1000 2320 -990 {lab=#net4}
N 960 -520 960 -510 {
lab=#net5}
N 1470 -1240 1470 -1200 {lab=VDD}
N 1470 -1200 1490 -1200 {lab=VDD}
N 1520 -1170 1520 -1160 {lab=VSS}
N 1520 -1280 1520 -1230 {lab=v_gain}
N 1320 -1280 1520 -1280 {lab=v_gain}
...
N 1710 -1400 1710 -1360 {lab=VDD}
N 1710 -1360 1730 -1360 {lab=VDD}
N 1760 -1330 1760 -1320 {lab=VSS}
N 1760 -1440 1760 -1390 {lab=VDD}
N 1320 -1440 1760 -1440 {lab=VDD}
N 1760 -1480 1760 -1440 {lab=VDD}
N 1520 -1280 2480 -1280 {lab=v_gain}
...
N 2710 -900 2880 -900 {lab=#net6}
N 2880 -900 2880 -800 {lab=#net6}
N 2880 -800 3560 -800 {lab=#net6}
N 2710 -920 2880 -920 {lab=#net7}
N 2880 -960 2880 -920 {lab=#net7}
N 2880 -960 3560 -960 {lab=#net7}
N 1360 -320 1360 -280 {lab=VSS}
N 1320 -320 1360 -320 {lab=VSS}
N 2240 -320 2240 -280 {lab=VSS}
N 2200 -320 2240 -320 {lab=VSS}
N 2200 -400 2240 -400 {lab=VSS}
N 2240 -400 2240 -320 {lab=VSS}
N 2200 -480 2240 -480 {lab=VSS}
N 2240 -480 2240 -400 {lab=VSS}
N 2200 -560 2240 -560 {lab=VSS}
N 2240 -560 2240 -480 {lab=VSS}
N 2200 -640 2240 -640 {lab=VSS}
N 2240 -640 2240 -560 {lab=VSS}
...
C {sg13g2_pr/diodevss_2kv.sym} 1520 -1200 0 0 {name=D2
model=diodevss_2kv
spiceprefix=X
m=1
}
C {pwroli.sym} 1520 -1160 0 1 {name=l2 lab=VSS}
C {pwroli.sym} 1470 -1240 2 0 {name=l8 lab=VDD
}
...
C {sg13g2_pr/diodevss_2kv.sym} 1760 -1360 0 0 {name=D1
model=diodevss_2kv
spiceprefix=X
m=1
}
C {pwroli.sym} 1760 -1320 0 1 {name=l5 lab=VSS}
C {pwroli.sym} 1710 -1400 2 0 {name=l7 lab=VDD
}
C {pwroli.sym} 1760 -1480 2 0 {name=l34 lab=VDD
}
...
C {sg13g2_pr/bondpad.sym} 2160 -320 3 0 {name=X13
model=bondpad
spiceprefix=X
size=80u
shape=0
...
C {pwroli.sym} 2240 -280 0 1 {name=l36 lab=VSS}
C {sg13g2_pr/bondpad.sym} 2160 -400 3 0 {name=X14
model=bondpad
spiceprefix=X
size=80u
shape=0
...
C {sg13g2_pr/bondpad.sym} 2160 -480 3 0 {name=X15
model=bondpad
spiceprefix=X
size=80u
shape=0
...
C {sg13g2_pr/bondpad.sym} 2160 -560 3 0 {name=X16
model=bondpad
spiceprefix=X
size=80u
shape=0
...
C {sg13g2_pr/bondpad.sym} 2160 -640 3 0 {name=X17
model=bondpad
spiceprefix=X
size=80u
shape=0
...
C {lab_pin.sym} 1370 -480 1 0 {name=p2 sig_type=std_logic lab=d3}
C {lab_pin.sym} 1370 -640 1 0 {name=p3 sig_type=std_logic lab=d2}
C {lab_pin.sym} 1370 -800 1 0 {name=p4 sig_type=std_logic lab=d1
}
C {lab_pin.sym} 1370 -960 1 0 {name=p5 sig_type=std_logic lab=d0}
C {lab_pin.sym} 1370 -1120 1 0 {name=p6 sig_type=std_logic lab=v_freq}
C {lab_pin.sym} 1370 -1280 1 0 {name=p7 sig_type=std_logic lab=v_gain
}
