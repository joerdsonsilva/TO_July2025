...
N 1200 -1840 1200 -1760 {lab=LC1}
N 880 -1840 880 -1760 {lab=LC0}
...
N 1040 -1920 1040 -1870 {lab=#net20}
N 880 -1840 1000 -1840 {lab=LC0}
N 880 -1920 880 -1840 {lab=LC0}
N 1080 -1840 1200 -1840 {lab=LC1}
N 1200 -1920 1200 -1840 {lab=LC1}
...
m=1
spice_ignore=open}
C {sg13g2_pr/rppd.sym} 720 -1440 3 0 {name=R2
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 1360 -1440 3 0 {name=R3
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 720 -1120 3 0 {name=R4
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 1360 -1120 3 0 {name=R5
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 720 -800 3 0 {name=R6
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 1360 -800 3 0 {name=R7
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 720 -480 3 0 {name=R8
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {sg13g2_pr/rppd.sym} 1360 -480 3 0 {name=R9
w=0.5e-6
l=20e-6
model=rppd
body=sub!
...
C {pwroli.sym} 1040 -1810 0 1 {name=l41 lab=VSS}
C {sg13g2_pr/sg13_svaricap.sym} 1040 -1840 0 0 {name=C1 model=sg13_hv_svaricap w=9.74e-6 l=0.8e-6 Nx=30 spiceprefix=X
spice_ignore=open}
